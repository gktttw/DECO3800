...
<head>
    ...
    <meta name="description" content="LiquidPro">
    <meta name="author" content="LiquidPro">
    <meta name="keywords" content="LiquidPro">
    ...
    <!-- Main CSS-->
    <link href="<?=base_url('/assets/css/');?>registration.css" rel="stylesheet" media="all">
</head>
                        ...
                        <div class="row row-space">
                            ...
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" type="confirmed password" name="confirmed password">
                                </div>
                            </div>
                        </div>
                        <div class="p-t-15">
